...
public class Day2Review {
	...
	public static void main(String[] args) {
		...
		for (int prime = 2; prime < 50; prime++) {
			// we want to make sure that isPrime is "true" by default
...
// Primite types does not have the default value.
// int, double, long, byte, short, float, char, boolean
// Non-primitve types always have default value
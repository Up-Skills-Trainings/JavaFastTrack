...
public class CallByValueCallByRef {
	...
	// this is called call by VALUE, methods do not know the other methods
	// variables.
	private static void changeTheValue(int number) {
		number = 1000;
		System.out.println("The value of the number inside of the method " + number);
	}

	// once you sent a reference to method, if you change the value, you are
	// actually changing the value of that object
